    ...
    <div>
      ...
      <div className="page-inner" style={{ maxWidth: '720px', margin: '0 auto' }}>
        <form onSubmit={handleSubmit}>
          ...
          <div className="card" style={{ marginBottom: 'var(--space-4)' }}>
            <div className="card-header">
              <h2 className="text-headline-sm" style={{ fontSize: '16px', fontWeight: 700 }}>Location & Schedule</h2>
            </div>
            <div className="card-body" style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-4)' }}>
          ...
          <div className="card" style={{ marginBottom: 'var(--space-6)' }}>
            <div className="card-header">
              <h2 className="text-headline-sm" style={{ fontSize: '16px', fontWeight: 700 }}>Budget</h2>
            </div>
            <div className="card-body" style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-4)' }}>
                ...
                {[
                  ...
                  <label
                    ...
                    style={{
                      flex: 1,
                      padding: 'var(--space-4)',
                      border: `1.5px solid ${form.budgetType === opt.value ? 'var(--color-secondary)' : 'var(--color-outline-variant)'}`,
                  ...
                  >
                    <input
                      ...
                      style={{ display: 'none' }}
                    />
                    <div style={{ fontWeight: 700, fontSize: 'var(--text-body-sm)', color: 'var(--color-secondary)', marginBottom: '4px' }}>{opt.label}</div>
